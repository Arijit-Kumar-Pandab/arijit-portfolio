...
import bannerImage from "../assets/arijit.png";
...
const Banner = () => {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ["Android Developer", "Backend Developer"], // Strings to display
    ...
    >
      ...
      <div className="w-full flex items-center justify-center text-white ">
        ...
        <div className="w-2/3 space-y-2  ms-10">
          ...
          <h1 className="text-5xl font-bold">Arijit Kumar Pandab</h1>
